...
> = ResolversObject<{
  ...
  searchCoursesByName?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<Query_SearchCoursesByNameArgs, 'course_name'>
  >;
  searchCoursesByTeacher?: Resolver<
    Maybe<Array<Maybe<ResolversTypes['Course']>>>,
    ParentType,
    ContextType,
    RequireFields<Query_SearchCoursesByTeacherArgs, 'teacher_name'>
  >;
  searchCoursesByBlock?: Resolver<
    Maybe<Array<Maybe<ResolversTypes['Course']>>>,
    ParentType,
    ContextType,
    RequireFields<Query_SearchCoursesByBlockArgs, 'block'>
  >;
